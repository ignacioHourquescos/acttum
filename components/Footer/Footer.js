            ...
            <div >
                {lang == "ESP"
                    ...
                    <div className={ss.container}>
                        ...
                        <div className={ss.link}><Link href="/busquedas">     Búsquedas</Link></div>
                        <div className={ss.link}><Link href="/servicios">   Servicios</Link></div>
                        <div className={ss.link}><Link href="/quienesSomos">            Quienes Somos</Link></div>
                ...
                <div className={ss.footer_social_container}>
                  ...
                  <Link href="https://www.instagram.com/acttum.consultora/?hl=en">{IGLogo}</Link>
                  <Link href="https://ar.linkedin.com/company/acttumconsultores">{INLogo}</Link>
